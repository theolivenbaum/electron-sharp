    ...
    public class MenusController : Controller
    {
        public IActionResult Index()
        {
            if (HybridSupport.IsElectronActive)
            {
                ...
                new MenuItem { Label = "Help", Role = MenuRole.help, Submenu = new MenuItem[] {
                    ...
                    {
                        Label = "Learn More",
                        Click = async () => await Electron.Shell.OpenExternalAsync("https://github.com/ElectronSharp")
                    }
                }
                }
            };
        ...
        private void CreateContextMenu()
        {
            var menu = new MenuItem[]
            {
                ...
                {
                    Label = "Hello",
                    Click = async () => await Electron.Dialog.ShowMessageBoxAsync("ElectronSharp rocks!")
                },
                new MenuItem { Type = MenuType.separator },
                new MenuItem { Label = "ElectronSharp", Type = MenuType.checkbox, Checked = true }
            };
